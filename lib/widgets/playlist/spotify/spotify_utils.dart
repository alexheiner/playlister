...
//   List<Widget> tracks;
//   Playlist playlist;
//   PlaylistContent(this.tracks,this.playlist);
// }
class SpotifyUtils {
  ...
  // static PlaylistContent _getPlaylistData(Playlist playlist) {
  //   List<Widget> listItems = [];
  //   List<Track> tracks = playlist.tracks;
  //   print('number of tracks' + tracks.length.toString());
  ...
  //       )));
  //   });
  //   return new PlaylistContent(listItems, playlist);
  // }
  ...
  Widget getTrackWidget(Track track){
    return Container(
        height: 70,
        margin: const EdgeInsets.symmetric(horizontal: 0, vertical: 6),
        decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5.0)), color: const Color(0x202020), boxShadow: [
